...
const ConsumeDashboard = () => {
    ...
    const [showDes4, setShowDes4] = useState(false);
                            ...
                            <Container>
                                ...
                                <Row className="justify-content-center">
                                    <Col md={2}>
                                        <Button
                                            onClick={() =>
                                                setShowDes1(!showDes1)
                                            }
                                        >
                                            {showDes1 ? "Ẩn" : "Hiện"} bảng
                                            thông kê
                                        </Button>
                                    </Col>
                                </Row>
                            ...
                            <Container>
                                ...
                                <Row className="justify-content-center">
                                    <Col md={2}>
                                        <Button
                                            onClick={() =>
                                                setShowDes3(!showDes3)
                                            }
                                        >
                                            {showDes3 ? "Ẩn" : "Hiện"} bảng
                                            thông kê
                                        </Button>
                                    </Col>
                                </Row>
                            ...
                            <Container>
                                ...
                                <Row className="justify-content-center">
                                    <Col md={2}>
                                        <Button
                                            onClick={() =>
                                                setShowDes4(!showDes4)
                                            }
                                        >
                                            {showDes4 ? "Ẩn" : "Hiện"} bảng
                                            thông kê
                                        </Button>
                                    </Col>
                                </Row>
